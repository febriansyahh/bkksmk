...
$no=1;
if($loker == 'NULL'){
$query=mysqli_query($con,"SELECT a.idDaftar, b.nisn, b.nama, d.nmJurusan, c.perusahaan, c.nmLoker, a.status FROM pendaftaran a, siswa b, lowongan c, jurusan d WHERE a.idAnggota=b.idSiswa AND a.idLoker=c.idLowongan AND b.jurusan=d.idJurusan AND c.usrInput ='$id' ORDER BY c.idLowongan ASC");
}else{
  
$query=mysqli_query($con,"SELECT a.idDaftar, b.nisn, b.nama, d.nmJurusan, c.perusahaan, c.nmLoker, a.status FROM pendaftaran a, siswa b, lowongan c, jurusan d WHERE a.idAnggota=b.idSiswa AND a.idLoker=c.idLowongan AND b.jurusan=d.idJurusan AND c.idLowongan = '$loker' AND c.usrInput ='$id' ORDER BY c.idLowongan ASC");
}
